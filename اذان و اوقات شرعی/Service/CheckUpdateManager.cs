...
namespace اذان_و_اوقات_شرعی.Service
{
    class CheckUpdateManager
    {
        ...
        {
            HttpWebRequest request = (HttpWebRequest)HttpWebRequest.Create("https://api.github.com/repos/hamerstandr/Adhan-and-religious-prayers/releases/latest");
                    ...
                    if (response.StatusCode == HttpStatusCode.OK)
                    {
                        using (StreamReader reader = new StreamReader(response.GetResponseStream()))
                        {
                            ...
                            if (Tool.CompareTwoVersionString(tag_name, currentVersion) > 0)
                            {
                                ...
                                {
                                    System.Diagnostics.Process.Start("https://github.com/hamerstandr/Adhan-and-religious-prayers/releases/latest");
                                }
                            }
                            else
                            {
