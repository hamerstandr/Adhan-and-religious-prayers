...
using static اذان_و_اوقات_شرعی.Medol.WindowsTaskbar;
...
namespace AppBarApplication
{
    ...
    internal static class AppBarFunctions
    {
        ...
        public static State Current
        {
            ...
            {
                var state = new State();
                var hWnd = اذان_و_اوقات_شرعی.Interop.User32.FindWindow("Shell_TrayWnd", null);
                ...
                var ret=SHAppBarMessage((int)ABMsg.ABM_REMOVE, ref appBarData);

                if (ret!=0)
                {
                    state.Size = new اذان_و_اوقات_شرعی.Interop.RECT()
                    {
                ...
                {
                    اذان_و_اوقات_شرعی.Interop.User32.GetWindowRect(hWnd, out state.Size);
