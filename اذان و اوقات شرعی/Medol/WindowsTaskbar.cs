    ...
    public sealed class WindowsTaskbar
    {
        ...
        public static State Current
        {
            get
            {
                ...
                if (HRESULT.S_OK == Shcores.GetDpiForMonitor(User32.MonitorFromWindow(hWnd, User32.MONITOR_DEFAULT.MONITOR_DEFAULTTONEAREST), Shcores.DpiType.Effective, out uint dpiX, out uint dpiY))
                {
                    state.Dpi = dpiY / 96f;
                }
                ...
                var b = Shell32.SHAppBarMessage(AppBarMessage.GetTaskbarPos, ref appBarData);
